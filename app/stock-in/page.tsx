...
export default function QuickStockInPage() {
  ...
  async function selectProduct(productData: ProductSearchItem) {
    ...
    try {
      ...
      const normalizedUnits: ProductUnit[] = (unitsData || []).map(
        (item: any) => ({
          id: item.id,
      ...
      if (baseUnit) {
        ...
        setSelectedUnitId(normalizedUnits[0].unit_id);
      } else {
        setSelectedUnitId("");
      }
      ...
      setProductUnits([]);
      setError(
        err?.message || "حدث خطأ أثناء تحميل بيانات المنتج",
      );
    } finally {
  ...
  async function handleSave() {
    ...
    try {
      ...
      setError(
        err?.message || "حدث خطأ أثناء إدخال المخزون",
      );
    } finally {
      setSaving(false);
    }
      ...
      <div className="mx-auto max-w-2xl">
        ...
        <div className="mb-5 flex items-center justify-between gap-3">
          <div>
            ...
            <p className="mt-1 text-sm text-slate-500">
              اختر المنتج بالاسم ثم أدخل الكمية واحفظ بسرعة
            </p>
          </div>
          ...
          <section className="rounded-3xl border border-slate-200 bg-white p-4 shadow-sm sm:p-5">
            ...
            <div className="relative">
              <input
                ...
                autoComplete="off"
                className="min-h-16 w-full rounded-2xl border-2 border-slate-300 bg-slate-50 px-5 text-lg font-bold outline-none transition focus:border-emerald-500 focus:bg-white focus:ring-4 focus:ring-emerald-100"
              />
                  ...
                  {searchResults.length > 0 ? (
                    searchResults.map((item) => (
                      <button
                        ...
                        className="flex w-full items-center gap-3 rounded-xl p-3 text-right transition hover:bg-emerald-50 active:bg-emerald-100"
                      >
                        {item.image_url ? (
                          <img
                            src={item.image_url}
        ...
        {product && (
          <section className="mt-4 overflow-hidden rounded-3xl border border-emerald-200 bg-white shadow-sm">
            ...
            {/* Product Header */}
            <div className="flex items-center gap-4 bg-emerald-50 p-4 sm:p-5">
              {product.image_url ? (
                <img
            ...
            <div className="p-4 sm:p-5">
              ...
              <div className="grid gap-3 sm:grid-cols-[1fr_180px]">
                ...
                <div>
                  ...
                  <input
                    ...
                    placeholder="مثال: 50"
                    inputMode="decimal"
                    className="min-h-16 w-full rounded-2xl border-2 border-slate-300 bg-white px-4 text-center text-2xl font-black outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    className="min-h-16 w-full rounded-2xl border-2 border-slate-300 bg-white px-4 text-center text-lg font-black outline-none transition focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
                  >
              ...
              {/* Conversion */}
              {selectedUnit && numericQuantity > 0 && (
                <div className="mt-3 rounded-2xl bg-emerald-50 px-4 py-3 text-center text-sm font-bold text-emerald-800">
                  📦 سيتم إضافة{" "}
                  ...
                  <div className="mt-3 grid gap-3 sm:grid-cols-2">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="min-h-12 w-full rounded-2xl border border-slate-300 bg-white px-4 font-bold outline-none focus:border-emerald-500 focus:ring-4 focus:ring-emerald-100"
                      />
                    </div>
              ...
              <button
                ...
                className="mt-5 min-h-16 w-full rounded-2xl bg-emerald-600 text-lg font-black text-white shadow-md transition hover:bg-emerald-700 disabled:cursor-not-allowed disabled:opacity-50"
              >
                {saving
                  ? "⏳ جاري الحفظ..."
                  : "📥 حفظ إدخال المخزون"}
              ...
              <p className="mt-3 text-center text-xs text-slate-400">
                يمكنك الضغط على Enter بعد كتابة الكمية للحفظ مباشرة
              </p>
            </div>
          </section>
        )}
        ...
        <div className="mt-5 grid grid-cols-2 gap-3">
          <button
            ...
            className="rounded-2xl border border-red-200 bg-red-50 px-4 py-4 font-black text-red-700 transition hover:bg-red-100"
          >
            📤 إخراج مخزون
          </button>
